const bernOverviewPlaces = [
  ...
  ["Gimmelwald", 46.5470, 7.8907, "village", "安靜的山坡無車村落"],
  ...
  ["Gruyères", 46.5847, 7.0833, "city", "中世紀山丘村、城堡與奶酪文化"],
...
function renderBernOverviewMap() {
  ...
  const bounds = [];
  bernOverviewPlaces.forEach(([name, lat, lng, category, description]) => {
    L.marker([lat, lng], {
      icon: bernOverviewIcon(bernOverviewGlyphs[category], category),
